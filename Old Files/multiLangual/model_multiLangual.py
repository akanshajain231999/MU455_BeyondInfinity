...
#height = [76,81,71,69,45,82,77,84,69,77] 
#tick_label = ['Decision Tree', 'Random Forest', 'SVC', 'K Neighbors', 'Gaussian N B', 'ExtraTrees', 'GradientBoosting', 'LogisticRegression', 'BernoulliNB','MultinomialNB'] 
#  
