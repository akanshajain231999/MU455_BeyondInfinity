...
import pandas as pd
df1 = pd.read_csv("test_modified.csv",engine='python')
...
dataframe_score = df1['Sentiment_Score']
final = pd.concat([dataframe_comments, dataframe_score],axis=1)
final.to_csv('test_modified1.csv')
#***************************************************************************************
...
#final.to_csv('chattrain_modified1.csv')
#
import pandas as pd
df = pd.read_csv("chattrain_modified1.csv")
df1 = pd.read_csv("review_train_test1.csv")
df2 = pd.read_csv("test_modified1.csv",engine='python')
df3 = pd.read_csv("train_modified1.csv",engine='python')
df4 = pd.read_csv("test_preprocessed_modified1.csv")
df5 = pd.read_csv("train_preprocessed_modified1.csv")
final_train = pd.concat([df,df1,df2,df3,df4,df5],axis=0)
final_train.reset_index(inplace = True) 
final_train = final_train.drop(['index'], axis = 1) 
final_train.to_csv('final_train1.csv')
